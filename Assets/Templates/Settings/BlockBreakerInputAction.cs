...
//     version 1.14.0
//     from Assets/Templates/Settings/BlockBreakerInputAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Templates/Settings/BlockBreakerInputAction.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @BlockBreakerInputAction: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @BlockBreakerInputAction()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""BlockBreakerInputAction"",
    ""maps"": [
        {
            ""name"": ""Paddle"",
            ""id"": ""a77d9b74-b474-4a71-a3d8-564d0b2c294a"",
            ""actions"": [
                {
                    ""name"": ""TouchPress"",
                    ""type"": ""Button"",
                    ""id"": ""769fe737-fd62-418f-a2b4-45d0110fec59"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""TouchPosition"",
                    ""type"": ""Value"",
                    ""id"": ""2ff9708c-9656-4b56-a870-f113d7684436"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""82ec6dc7-50e5-4a3c-b4ec-79ea4c46237d"",
                    ""path"": ""<Pointer>/press"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""ba04545d-2864-4c5d-8456-502e8d4d7f3d"",
    ...
    ""controlSchemes"": []
        ...
        m_Paddle_TouchPress = m_Paddle.FindAction("TouchPress", throwIfNotFound: true);
        m_Paddle_TouchPosition = m_Paddle.FindAction("TouchPosition", throwIfNotFound: true);
    }

    ~@BlockBreakerInputAction()
    {
        UnityEngine.Debug.Assert(!m_Paddle.enabled, "This will cause a leak and performance issues, BlockBreakerInputAction.Paddle.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Paddle_TouchPress;
    private readonly InputAction m_Paddle_TouchPosition;
    /// <summary>
    /// Provides access to input actions defined in input action map "Paddle".
    /// </summary>
    public struct PaddleActions
    {
        private @BlockBreakerInputAction m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PaddleActions(@BlockBreakerInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Paddle/TouchPress".
        /// </summary>
        public InputAction @TouchPress => m_Wrapper.m_Paddle_TouchPress;
        /// <summary>
        /// Provides access to the underlying input action "Paddle/TouchPosition".
        /// </summary>
        public InputAction @TouchPosition => m_Wrapper.m_Paddle_TouchPosition;
        /// <summary>
